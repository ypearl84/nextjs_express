...
const Article = (props) => {
  ...
  //  if(date.p3==undefined) {
        /*아티클 날짜가 없을 떄 어떤 식으로 아티클 날짜 찾아가는지 확인 필요*/
   //     const url = `http://data.koreatimes.com/article/${p2Index}/${date.p2}.data`
   // } else {
   ...
   // }
    ...
    return (
        <div id="container" className="bg_container">
            <AdArea pathname={props.match.params.p1} />
